...
echo '
   ...
   <div class="footer-basic">
        <footer>
            <!-- Start: Social Icons -->
            <div class="social"><a href="https://instagram.com/himy.in"><i class="icon ion-social-instagram"></i></a></div><!-- End: Social Icons -->
            <!-- Start: Links -->
            <ul class="list-inline">
                <li class="list-inline-item"><a href="/">Home</a></li>
                <li class="list-inline-item"><a href="/about">About</a></li>
                <li class="list-inline-item"><a href="https://hackedserver.blogspot.com">Blog</a></li>
            </ul><!-- End: Links -->
            <!-- Start: Copyright -->
            
            <p class="copyright" style="font-family: Arial, Helvetica, sans-serif;font-size:14px;">Vedik Cyber Forces<br> Contact: admin@vcfstudio.in</p><!-- End: Copyright -->
        </footer>
